...
const Search = ({videos}:{videos:Video[]}) => {
    ...
    const {allUsers} = useAuthStore();// get all the users
  ...
  // find all user accounts matching the search term
        ...
        <div className='md:mt-16'>
          {searchedAccounts.length > 0 ? (
            ...
            <div className='md:mt-16 flex flex-wrap gap-6 md:justify-start'>
                {/* map over videos if exist and render video card for each one */}
                {videos.length ? (
